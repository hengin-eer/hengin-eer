# Hi!  I'm timdaik
[![thumbnail](./ogp.png)](https://hiro-to.moda)

<img align="right" src="https://visitor-badge.laobi.icu/badge?page_id=hengin-eer.hengin-eer&right_color=darkturquoise"  />

## About Me
> timdaik (Pronounced: /tɪmdaɪk/ — Tim-dyke)

- Fifth-year info engineering student at a Japanese tech college.
- Transferring as a third-year to Nagaoka University of Technology's Information and Management Systems Engineering in 2026.
- I deeply love playing catch, fish, and markup languages.

## What I like
- ⚾ Play Catch (I’m passionate about this!!)
- 🐟 Fish (fishing, eating, illustration, watching and more)
- ⌨️ Programming (main: Web Develop, and others)
- ☕ Tea&Coffee (Darjeeling tea especially)

## I develop with
> I'm in the process of categorizing them by skill level.
<!--
![Skills](https://skills.syvixor.com/api/icons?radius=60&i=)
-->
### Languages
![Skills](https://skills.syvixor.com/api/icons?radius=60&i=html,css,svg,js,ts,c,arduino,python,haskell,go,lua,markdown,typst,latex)

### Frameworks
![Skills](https://skills.syvixor.com/api/icons?radius=60&i=nextjs,astro,vue,svelte,gatsby,django,flask)

### Library
![Skills](https://skills.syvixor.com/api/icons?radius=60&i=tailwindcss,sass,react,threejs,jquery,p5js,slidev,reactrouter,authjs,recoil,jotai,zod,mermaid)

### Toolchains
![Skills](https://skills.syvixor.com/api/icons?radius=60&i=webpack,vite,nodejs,npm,jest,vitest,githubactions,docker,prettier,eslint,biome)

### DB
![Skills](https://skills.syvixor.com/api/icons?radius=60&i=firebase,postgresql,prisma,supabase)

### Env / Editor / etc
![Skills](https://skills.syvixor.com/api/icons?radius=60&i=windows,ubuntu,vscode,vim,neovim,bash,git,zen,figma,notion,obsidian)
...
## My Activities
<div>
<img src="https://github-readme-stats.vercel.app/api/top-langs?username=hengin-eer&locale=en&hide_title=false&layout=compact&card_width=320&langs_count=10&theme=react&hide_border=false&order=2&custom_title=Languages%20I%20use..." height="180" alt="languages graph"  />
<img src="https://streak-stats.demolab.com?user=hengin-eer&locale=en&mode=daily&theme=react&hide_border=false&border_radius=8&date_format=%5BY.%5Dn.j&order=3" height="180" alt="streak graph"  />
</div>
